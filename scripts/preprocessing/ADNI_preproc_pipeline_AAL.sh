...
T1W="${T1W:-*T1w.nii.gz}"
AAL_MNI="${AAL_MNI:-${SC_ATLAS_ROOT:-${SC_PROJECT_ROOT:-$(cd "$(dirname "$0")/../.." && pwd)}/atlas}/AAL/AAL3v1_1mm_166.nii.gz}"
MNI_BRAIN="${MNI_BRAIN:-${FSL_DIR}/data/standard/MNI152_T1_1mm_brain.nii.gz}"
FS_SUBJECT_DIR="${FS_SUBJECT_DIR:-${SUBJECTS_DIR:?set SUBJECTS_DIR or FS_SUBJECT_DIR}}"
THREADS="${THREADS:-8}"
