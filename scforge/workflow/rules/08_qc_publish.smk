...
rule provenance_sidecar:
    input:
        matrix_qc=rules.matrix_qc.output[0],
        spatial_qc=rules.spatial_quantitative_qc.output[0],
        tractography_preflight=rules.tractography_preflight.output[0],
        ...
        mni_brain_template=str(MNI_BRAIN_TEMPLATE),
        ...
        assignments=rules.connectome_count.output.assignments,
        node_volumes=rules.count_invnodevol.output.node_volumes,
        gradient_qc=rules.gradient_contract.output[0],
        ...
        atlas_dwi=rules.aal3_to_dwi_single_resample.output[0],
        ...
        tensor=rules.tensor_fit.output[0],
    ...
    run:
        ...
        record = {
            ...
            "contract_files": {
                ...
                "mni_brain_template": file_record(input.mni_brain_template),
