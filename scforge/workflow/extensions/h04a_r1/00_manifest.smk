"""SL-H04A-R1 manifest snapshot and execution-environment gate.

This rule copy preserves the locked base preflight checks while validating the
separately approved R1 response-recovery authorization profile.
"""
...
rule execution_preflight:
    ...
    run:
        ...
        h04a_expected = {
            ...
            "storage_stop_gb": 100,
            "storage_stop_bytes": 100 * 1_000_000_000,
