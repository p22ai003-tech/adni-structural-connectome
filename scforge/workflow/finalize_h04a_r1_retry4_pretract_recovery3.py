"""Versioned terminal publication for retry4 pretract Recovery3."""
...
LEDGER_NAME = "pre_tractography_canary_recovery3_ledger.jsonl"
MANIFEST_NAME = "pre_tractography_canary_recovery3_manifest.json"


def finalize_recovery3(
    *,
    base: Any,
    run_root: Path,
    ...
    """Publish Recovery3 without overwriting any earlier immutable release."""
    ...
    for unit in expected_units:
        ...
        automated_qc_path = (
            review_dir / "automated_pre_tractography_qc_recovery3.json"
        )
        review_paths = {
            "b0_t1": review_dir / "review_b0_vs_t1_recovery3.png",
            "b0_5tt": review_dir / "review_b0_vs_5tt_recovery3.png",
            "b0_atlas": review_dir / "review_b0_vs_aal3_recovery3.png",
            "index": review_dir / "visual_review_index_recovery3.csv",
        }
        ...
        entry = {
            ...
            "entry_type": "pre_tractography_canary_recovery3_outcome",
            "run_id": run_id,
    ...
    manifest = {
        "schema_version": "2.0.0",
        "record_type": "pre_tractography_canary_recovery3_manifest",
        "status": "COMPLETE",
